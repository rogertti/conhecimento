        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var settings = $data.settings = $.extend({
                    ...
                    'buttonText': 'Selecionar Arquivos', // The text that appears on the UploadiFive button
                ...
                if (window.File && window.FileList && window.Blob && (window.FileReader || window.FormData)) {
                    ...
                    $data.button = $('<div id="' + settings.id + '" class="btn btn-default uploadifive-button">' + settings.buttonText + '</div>');
